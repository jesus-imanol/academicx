...
const TeacherForm = ({ onSubmit, onCancel }) => {
  ...
  return (
    <div className="mt-8 rounded-xl border border-white/10 bg-[#252233] p-8">
      <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-2">
          <h3 className="text-lg font-bold text-white tracking-wide">Platform Credentials</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <label className="flex flex-col min-w-40 flex-1">
        ...
        <div className="flex flex-col gap-2">
          <h3 className="text-lg font-bold text-white tracking-wide">Administrative</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <label className="flex flex-col min-w-40 flex-1">
        ...
        <div className="flex items-center justify-end gap-4 pt-6 border-t border-white/10">
          <button
            type="button"
            onClick={onCancel}
            className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-11 px-6 bg-transparent text-white/80 hover:bg-white/10 text-sm font-bold leading-normal tracking-[0.015em] transition-colors duration-200"
          >
            <span className="truncate">Cancel</span>
          </button>
          <button
            type="submit"
            className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-11 px-6 bg-linear-to-r from-[#330df2] to-[#330df2] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:from-[#330df2] hover:to-[#330df2] hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300"
          >
